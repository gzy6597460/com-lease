...
class Bankinfo
{
    public static $bankBin = array(
        623668, 621098, 622150, 622151, 622181, 622188, 955100, 621095, 620062, 621285, 621798, 621799,
    ...
    public static $bankName = array(
        "建设银行·龙卡通","邮储银行·绿卡通", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡专用卡", "邮储银行·绿卡银联标准卡",
...
//$bank = new Bankinfo();
//echo $bank->getname("6222081502002040922");